                ...
                {group.items.map((item, idx) => (
                  <TableRow
                    ...
                    className={cn(
                      ...
                      item.status === 'Recebido' && 'opacity-70',
                    )}
                  >
                    <TableCell className="text-muted-foreground">{idx + 1}</TableCell>
                    <TableCell
                      className={cn('font-medium', item.status === 'Recebido' && 'line-through')}
                    >
                      {item.nome}
                    </TableCell>
                    <TableCell className={cn(item.status === 'Recebido' && 'line-through')}>
                      {item.cpf}
                    </TableCell>
                    <TableCell
                      className={cn('text-sm', item.status === 'Recebido' && 'line-through')}
